...
<div class="min-h-full">
    ...
    <div id="listaView" class="p-8">
        ...
        <!-- Header con botones Configurar QR y Agregar Cliente -->
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Gestión de Multas</h1>
            <div class="flex space-x-3">
                <a href="{{ route('configuracion.qr') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition shadow-sm text-sm">
